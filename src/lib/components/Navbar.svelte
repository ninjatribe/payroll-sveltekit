<script>
  import AccountProfileForm from '$lib/components/forms/AccountProfileForm.svelte';
  ...
  <div class="px-3 py-2 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
        <a href="/" class="flex ml-2 md:mr-24">
          ...
          <span class="text-xl font-semibold dark:text-white text-gray-900" >Payroll System</span>
        </a>
