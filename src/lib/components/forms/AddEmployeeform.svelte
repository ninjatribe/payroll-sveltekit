	...
	<div class="flex items-center justify-center min-h-screen">
		...
		>
			<div class="p-6">
				...
				<div class="mt-4">
					<ul
						class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray dark:border-gray-700 dark:text-gray-400"
						id="mytab"
					...
					>
						<li class="ml-6" role="presentation">
							<button
								...
								id="Page1-tab"
								data-tabs-target="#page1"
								type="button"
								role="tab"
								aria-controls="page1"
								aria-selected="false">Page1</button
							>
						</li>
						<li class="ml-6" role="presentation">
							<button
								class="inline-block p-4 border-b-2 rounded-t-lg"
								id="Page2-tab"
								data-tabs-target="#page2"
								type="button"
								role="tab"
								aria-controls="page2"
								aria-selected="false">Page2</button
							>
						</li>
						<li class="ml-6" role="presentation">
							<button
								class="inline-block p-4 border-b-2 rounded-t-lg"
								id="Page3-tab"
								data-tabs-target="#page3"
								type="button"
								role="tab"
								aria-controls="page3"
								aria-selected="false">Page3</button
							>
						</li>
						<li class="ml-6" role="presentation">
							<button
								class="inline-block p-4 border-b-2 rounded-t-lg"
								id="Page4-tab"
								data-tabs-target="#page4"
								type="button"
								role="tab"
								aria-controls="page4"
								aria-selected="false">Page4</button
							>
						</li>
					</ul>
					<form class="w-full mx-auto" on:submit={handleSubmit}>
						...
						<div class="flex w-auto h-auto py-4 flex-start border-b-2 border-black">
							<div class="flex pr-3">
								<label for="Employee No." class="font-serrif text-large pl-4 m-2 h-12"
									>Employee No.</label
								>
								<input
									type="text"
							...
							<div class="flex pr-3">
								<label for="Scanning No." class="font-seriftext-large pl-40 m-2 h-12"
									>Scanning No.</label
								>
								<input
									type="text"
							...
							<div class="p-3 border-2 border-black w-full">
								<div class="grid grid-cols-8 h-auto w-full overflow-x-scroll pb-5">
									...
									<input
										type="text"
										id="carService"
										bind:value={empCivService.careerService}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="rating"
										bind:value={empCivService.rating}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="examDate"
										bind:value={empCivService.dateofExam}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="examPlace"
										bind:value={empCivService.placeofExam}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="lisence"
										bind:value={empCivService.lisence}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="lisenceNum"
										bind:value={empCivService.lisenceNo}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="liscenceDate"
										bind:value={empCivService.dateofValidity}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="civAction"
										bind:value={empCivService.Action}
										class="text-lg"
										required
									/>
								</div>
							...
							<div class="p-3 border-2 border-black">
								<div class="grid grid-cols-7 h-auto w-full pb-5">
									...
									<input
										type="text"
										id="prevPosTitle"
										bind:value={empWorkExperience.positionTitle}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="prevDepartment"
										bind:value={empWorkExperience.departmentAgencyOffice}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="prevMonthlySalary"
										bind:value={empWorkExperience.monthlySalary}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="prevSalaryGrade"
										bind:value={empWorkExperience.Salary}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="prevAppointmentStatus"
										bind:value={empWorkExperience.statusofAppointment}
										class="text-lg"
										required
									/>
									<input
										...
										bind:value={empWorkExperience.governmentService}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="prevAction"
										bind:value={empWorkExperience.Action}
										class="text-lg"
										required
									/>
								</div>
						...
						<!--Page 3-->
						<div class="border-b-2 border-black w-auto h-auto bg-white">
							<div class="py-4 text-2xl font-serif">
							...
							<div class="p-3 border-2 border-gray-600">
								<div class="grid grid-cols-6 h-auto w-full pb-5">
									...
									<input
										...
										bind:value={empCharityWork.nameandAdressofOrg}
										class="text-lg"
										required
									/>
									<input
										...
										bind:value={empCharityWork.from}
										placeholder="dd/mm/yyyy"
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="charityAttendDateTo"
										bind:value={empCharityWork.to}
										placeholder="dd/mm/yyyy"
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="charityNumberOfHours"
										bind:value={empCharityWork.numberOfHours}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="charityWorkNature"
										bind:value={empCharityWork.natureofWork}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="charityAction"
										bind:value={empCharityWork.action}
										class="text-lg"
										required
									/>
								</div>
							...
							<div class="p-3 border-2 border-black">
								<div class="grid grid-cols-7 h-auto w-full overflow-x-scroll pb-5">
									...
									<input
										type="text"
										id="ldAttendDateFrom"
										bind:value={empLearningAndDevelopment.to}
										placeholder="dd/mm/yyyy"
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="ldAttendDateTo"
										bind:value={empLearningAndDevelopment.from}
										placeholder="dd/mm/yyyy"
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="ldNumberofHours"
										bind:value={empLearningAndDevelopment.numberofHours}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="ldType"
										bind:value={empLearningAndDevelopment.type}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="ldConducted"
										bind:value={empLearningAndDevelopment.conductedBy}
										class="text-lg"
										required
									/>
									<input
										type="text"
										id="ldAction"
										bind:value={empLearningAndDevelopment.action}
										class="text-lg"
										required
									/>
								</div>
						...
						<div class="w-auto h-auto">
							...
							>
								...
								<label for="fileName" class="border-2 border-black p-2" />
								<div class="border-2 border-black p-2">
									<input
										type="file"
										id="emp_file_upload"
										name="emp_file_upload"
										bind:value={emp_file}
										required
									/>
								</div>
