<script>
    ...
    export let isDeleteEmployeeModalOpen = false;
    ...
    const handleCloseModal = () => isDeleteEmployeeModalOpen = false;
...
<div class="fixed z-10 inset-0 overflow-y-auto {isDeleteEmployeeModalOpen? 'block': 'hidden'}">
            ...
            <div class="relative w-full h-full max-w-md md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <h2 class="text-lg font-normal text-gray-800 dark:text-gray-400">{currentEmployee.empNo}</h2>
                        <h2 class="mb-2 text-lg font-normal text-gray-800 dark:text-gray-400">{currentEmployee.emp_email}</h2>
