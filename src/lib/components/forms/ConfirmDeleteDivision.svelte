<script>
    ...
    async function handleConfirmDelete(event)
    {
		...
		const response = await fetch('/api/admin/division/delete', {
			method: 'POST',
			headers: {
            ...
            <div class="relative w-full h-full max-w-md md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <h2 class="text-lg font-normal text-gray-800 dark:text-gray-400">{currentDivision.code}</h2>
                        <h2 class="mb-2 text-lg font-normal text-gray-800 dark:text-gray-400">{currentDivision.description}</h2>
