...
<div class="border-2 border-gray-100 overflow-x-auto rounded-lg h-auto dark:border-gray-700 mt-12">
	<div class="flex flex-col justify-center border-b h-fit rounded bg-blue-600 dark:bg-gray-800">
		<div class="flex flex-col px-5 justify-center py-4">
			<span class="text-xl font-semibold" style="color:white">Positions</span>
			<span class="text-m" style="color:white">Manage Positions</span>
		</div>
	...
	<div class="flex flex-col relative overflow-x-auto shadow-md sm:rounded-lg">
		<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
			<thead class="text-m  text-gray-700 border-b bg-gray-200 dark:bg-gray-700 dark:text-gray-400">
				<tr class="">
					<th scope="col" class="pl-6 py-3"> CODE </th>
					<th scope="col" class="pl-6 py-3">
						POSITION TITLE
						<Sort on:click={() => sortColumn('postionTitle')}/>
					</th>
					<th scope="col" class="pl-6 py-3">
						POSITION STATE
						<Sort on:click={() => sortColumn('postionState')}/>
					</th>
					<th scope="col" class="pl-6 py-3">
						SALARY GRADE
						<Sort on:click={() => sortColumn('salaryGrade')}/>
					</th>
					<th scope="col" class="pl-6 py-3">
						SALARY GRADE STEPS
						<Sort on:click={() => sortColumn('payGradeSteps')}/>
					</th>
